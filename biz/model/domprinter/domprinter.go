...
func (p *DOMPrinterServiceClient) Ping(ctx context.Context, request *PingReq) (r *PingResp, err error) {
	var _args DOMPrinterServicePingArgs
	_args.Request = request
	var _result DOMPrinterServicePingResult
...
func NewDOMPrinterServiceProcessor(handler DOMPrinterService) *DOMPrinterServiceProcessor {
	...
	self.AddToProcessorMap("Ping", &dOMPrinterServiceProcessorPing{handler: handler})
	return self
}
...
type dOMPrinterServiceProcessorPing struct {
	handler DOMPrinterService
}

func (p *dOMPrinterServiceProcessorPing) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := DOMPrinterServicePingArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := DOMPrinterServicePingResult{}
	var retval *PingResp
...
func NewDOMPrinterServicePingArgs() *DOMPrinterServicePingArgs {
	return &DOMPrinterServicePingArgs{}
}
...
func (p *DOMPrinterServicePingArgs) GetRequest() (v *PingReq) {
	if !p.IsSetRequest() {
		return DOMPrinterServicePingArgs_Request_DEFAULT
	}
	return p.Request
}

var fieldIDToName_DOMPrinterServicePingArgs = map[int16]string{
	1: "request",
}
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_DOMPrinterServicePingArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *DOMPrinterServicePingArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("request", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Request.Write(oprot); err != nil {
...
func (p *DOMPrinterServicePingArgs) String() string {
	...
	return fmt.Sprintf("DOMPrinterServicePingArgs(%+v)", *p)
}
...
func NewDOMPrinterServicePingResult() *DOMPrinterServicePingResult {
	return &DOMPrinterServicePingResult{}
}
...
func (p *DOMPrinterServicePingResult) GetSuccess() (v *PingResp) {
	if !p.IsSetSuccess() {
		return DOMPrinterServicePingResult_Success_DEFAULT
	}
	return p.Success
}

var fieldIDToName_DOMPrinterServicePingResult = map[int16]string{
	0: "success",
}
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_DOMPrinterServicePingResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *DOMPrinterServicePingResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *DOMPrinterServicePingResult) String() string {
	...
	return fmt.Sprintf("DOMPrinterServicePingResult(%+v)", *p)
}
